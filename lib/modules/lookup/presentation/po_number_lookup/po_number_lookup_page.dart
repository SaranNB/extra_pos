...
import 'package:extra_pos/modules/lookup/presentation/po_number_lookup/po_number_lookup_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class PONumberLookupPage extends StatelessWidget {
  final Function(PONumber selectedPONumber)? onPONumberSelected;
  final int? vendorBranchId;
  final int? vendorId;
  final int? vendorSiteBranchId;
  final int? vendorSiteId;
  final String? allowBackOrders;

 late PONumberLookupController controller;

  PONumberLookupPage(
      {this.vendorBranchId, this.vendorId, this.vendorSiteBranchId, this.vendorSiteId, this.onPONumberSelected, this.allowBackOrders});


  @override
  Widget build(BuildContext context) {
    this.controller = Get.put(PONumberLookupController(this.vendorBranchId!, this.vendorId!, this.vendorSiteBranchId!, this.vendorSiteId!, this.allowBackOrders!));
