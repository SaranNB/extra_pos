...
import 'package:extra_pos/core/app_assets/app_colors.dart';
...
class POReceiptsHomePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BaseScaffold(
      appBar: BaseAppBar(title: TT.appbar_title_po_receipts.tr),
      body: Column(
        children: [
          SizedBox(height: 24),
          SizedBox(
            ...
            child: GridView.count(
              ...
              children: [
                MenuIcon(
                    ...
                    onPressed: () {
                      Get.toNamed(Routes.listPoReceipts);
                    }),
                MenuIcon(
                  ...
                  iconColor: AppColors.secondaryMenuIconColor,
                  onPressed: () {
                    Get.toNamed(Routes.createPOReceipt);
                  },
                )
              ],
            ),
